...
def send_receive_client_message(client_connection, client_ip_addr):
    ...
    if len(clients) > 1:
        ...
        data1="opponent_name$" + clients_names[1] + "symbol" + symbols[0]
        data2="opponent_name$" + clients_names[0] + "symbol" + symbols[1]
        clients[0].send(data1.encode('utf-8'))
        clients[1].send(data2.encode('utf-8'))
